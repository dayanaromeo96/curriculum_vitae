...
const esTranslations = {
    titleProfile: 'Perfil',
    descProfile: 'Graduada en Ingeniería Informática dedicada al desarrollo de sistemas (FullStack) con más de 5 años de experiencia. Con una capacidad demostrable para adaptarme a diversas situaciones y tecnologías.',
    titleLanguage: 'IDIOMAS',
    esLang: 'Español',
    enLang: 'Inglés (básico)',
    titleTraining: 'Educación',
    ingInf: 'Ingeniera Informática',
    webDev: 'Líder Técnico',
    experienceTitle: 'Experiencia',
    experienceTitle1: 'Líder Técnico (Angular - Spring Boot)',
    experienceDate1: 'desde Diciembre 2022 - actualmente | IDS Comercial',
    experienceDesc1: 'Actualmente trabajo como consultora para GNP en el proyecto de Vital como Líder Técnico participando en todo el proceso de análisis, diseño y desarrollo de código. Además trabajé por 2 años en un proyecto de gran envergadura llamado Gestor Comercial donde me desempeñé como Líder técnico, supervisando al equipo de desarrollo y creando componentes reutilizables FrontEnd-BackEnd para mejorar el rendimiento y la arquitectura del proyecto. Como líder, impulso la innovación, optimizo la eficiencia del código y garantizo la entrega de soluciones de software de alta calidad. Estoy familiarizada con metodologías ágiles, resolución colaborativa de problemas y mentoría de miembros del equipo para alcanzar los objetivos del proyecto.',
    experienceTitle2: 'Desarrolladora Frontend - Líder técnico (React)',
    experienceDate2: 'desde Abril 2022 - Marzo 2023 | Rezglo',
